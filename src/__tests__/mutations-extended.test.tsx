 ...
 * buttons consistently carry `hover:text-red-400` (raw Tailwind palette —
 * the app shell reverted off the `text-error` design-token classes) so we use:
 *   container.querySelector('[class*="hover:text-red-400"]')
 *
...
describe('GroupsClient — deleteGroup', () => {
  ...
  it('success → item removed + router.refresh called', async () => {
    ...
    const del = container.querySelector<HTMLButtonElement>('[class*="hover:text-red-400"]')
