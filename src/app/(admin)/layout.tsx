...
const navItems = [
  ...
  { label: 'Academic',    href: '/admin/academic',     icon: 'Network' as const, academicOnly: true },
  { label: 'Groups',      href: '/admin/groups',       icon: 'Layers' as const, term: 'groups' as const },
  ...
  { label: 'Centre Staff',  href: '/admin/center-staff',  icon: 'ShieldCheck' as const, centerOnly: true },
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-slate-950">
      <TenantWatcher />
      <Sidebar items={navItems} title="University Admin" titleTerm="institutionAdmin" />
      <ContentShell>
