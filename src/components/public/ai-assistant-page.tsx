...
const dict = {
  ar: {
    ...
    features: [
      ...
      { icon: 'ClipboardList', title: 'اختبار بأسئلته وإجاباته', desc: 'يولّد أسئلة متنوعة (اختيار من متعدد، صح وخطأ، مقالية) مع الإجابة الصحيحة لكل سؤال، وتختار أنت أي الأسئلة تبقيها.' },
  ...
  en: {
    ...
    features: [
      ...
      { icon: 'ClipboardList', title: 'A full exam, questions and answers', desc: 'Generates varied questions (multiple choice, true/false, essay) with the correct answer for each, and you choose which ones to keep.' },
      { icon: 'PenLine', title: 'Fully editable before publishing', desc: 'Nothing publishes automatically. Everything the assistant generates lands in front of you first, so edit, remove, or add before any student sees it.' },
