...
const dict = {
  ar: {
    heroBadge: 'منصة تعليمية سحابية للمؤسسات التعليمية',
    heroTitle: 'أدر مؤسستك التعليمية من مكان واحد',
    heroDesc: 'EduQuest منصة متكاملة تجمع الدروس والاختبارات والعلامات والمراقبة الذكية — لكل مؤسسة تعليمية بيئتها المعزولة الخاصة، ولكل معلم وطالب لوحته البسيطة.',
    heroCta: 'اطلب اشتراكاً لمؤسستك',
    ...
    stats: [
      { value: '4', label: 'أدوار متكاملة', sub: 'مالك، مدير مؤسسة، معلم، طالب' },
      { value: 'ثوانٍ', label: 'لتوليد درس أو اختبار كامل', sub: 'بالذكاء الاصطناعي، قابل للتعديل' },
      { value: '100%', label: 'عزل البيانات بين المؤسسات', sub: 'على مستوى قاعدة البيانات نفسها' },
    ...
    trust: [
      ...
      { title: 'مرافقة كاملة عند البدء', desc: 'نجهّز بيئة مؤسستك بأنفسنا ونرافق فريقك خطوة بخطوة حتى تستقر العملية التعليمية.' },
    ],
    ...
    steps: [
      { title: 'اطلب اشتراكاً', desc: 'راسلنا عبر النموذج وأخبرنا عن مؤسستك.' },
      { title: 'نجهّز بيئتك', desc: 'ننشئ بيئة معزولة خاصة بمؤسستك ونسلّمك لوحة المالك.' },
    ...
    faqs: [
      { q: 'هل بيانات مؤسستنا معزولة عن غيرها؟', a: 'نعم، تماماً. كل مؤسسة لها بيئتها المعزولة على مستوى قاعدة البيانات — لا يرى أحد بيانات أحد.' },
    ...
    ctaTitle: 'جاهز تنقل مؤسستك للمستوى التالي؟',
    ctaDesc: 'راسلنا وسنجهز بيئة مؤسستك ونرافقكم خطوة بخطوة.',
    ctaButton: 'راسلنا الآن',
  },
  en: {
    heroBadge: 'Cloud platform for educational institutions',
    heroTitle: 'Run your institution from one place',
    heroDesc: 'EduQuest brings lessons, exams, grades and smart proctoring together — every school, university, institute or training centre gets its own isolated environment, and every teacher and student a simple dashboard.',
    ...
    stats: [
      { value: '4', label: 'Integrated roles', sub: 'Owner, institution admin, teacher, student' },
      { value: 'Seconds', label: 'To generate a full lesson or exam', sub: 'AI-powered, editable before publishing' },
      { value: '100%', label: 'Data isolation between institutions', sub: 'Enforced at the database level itself' },
    ...
    trust: [
      ...
      { title: 'Full onboarding support', desc: 'We set up your institution’s environment ourselves and guide your team step by step until everything runs smoothly.' },
    ],
    ...
    faqs: [
      { q: 'Is our institution’s data isolated from others?', a: 'Yes, completely. Each institution has its own isolated environment at the database level — no one can see anyone else’s data.' },
    ...
    ctaTitle: 'Ready to take your institution to the next level?',
    ctaDesc: 'Message us and we’ll set up your institution’s environment and guide you step by step.',
